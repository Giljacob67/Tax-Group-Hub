 ...
 */
export const BulkUpdateTemperatureCrmContactsBody = zod.object({
  ids: zod.array(zod.number()),
  temperatura: zod.string(),
});

export const BulkUpdateTemperatureCrmContactsResponse = zod.object({
  success: zod.boolean(),
  message: zod.string().optional(),
});
 ...
 */
export const BulkAssignCrmContactsBody = zod.object({
  ids: zod.array(zod.number()),
  responsavelUnidade: zod.string().optional(),
});

export const BulkAssignCrmContactsResponse = zod.object({
  success: zod.boolean(),
  message: zod.string().optional(),
});
 ...
 */
export const BulkUpdateFollowupCrmContactsBody = zod.object({
  ids: zod.array(zod.number()),
  proximoFollowup: zod.string().nullish(),
});

export const BulkUpdateFollowupCrmContactsResponse = zod.object({
  success: zod.boolean(),
  message: zod.string().optional(),
});
 ...
 */
export const ListCrmContactDistinctValuesQueryParams = zod.object({
  field: zod.coerce.string(),
});

export const ListCrmContactDistinctValuesResponse = zod.object({
 ...
 */
export const SeedSystemCrmViewsResponse = zod.object({
  success: zod.boolean().optional(),
  views: zod
    .array(
      zod.object({
 ...
 */
export const UpdateCrmViewParams = zod.object({
  id: zod.coerce.number(),
});

export const UpdateCrmViewBody = zod.object({
  name: zod.string().optional(),
  emoji: zod.string().optional(),
  filters: zod.record(zod.string(), zod.unknown()).optional(),
  isDefault: zod.boolean().optional(),
...
export const UpdateCrmViewResponse = zod.object({
  success: zod.boolean(),
  view: zod.object({
    id: zod.number(),
    name: zod.string(),
      ...
      zod.object({
        ...
        result: zod
          .object({
            score: zod.number().optional(),
            tier: zod.enum(["A", "B", "C", "D"]).optional(),
            temperatura_sugerida: zod
              .enum(["frio", "morno", "quente", "burning"])
              .optional(),
    ...
    .object({
      ...
      taskTemplate: zod
        .object({
          title: zod.string().optional(),
          type: zod
            .enum(["call", "email", "whatsapp", "meeting", "proposal", "note"])
            .optional(),
...
export const GetCrmOperationalSummaryResponse = zod.object({
  ...
  summary: zod
    .object({
      followupVencidos: zod.number().optional(),
      followupHoje: zod.number().optional(),
      reunioesHoje: zod.number().optional(),
      tarefasVencidas: zod.number().optional(),
      semAtividade7d: zod.number().optional(),
      semAtividade14d: zod.number().optional(),
      aguardandoMatriz: zod.number().optional(),
      pendenciaDocumental: zod.number().optional(),
      propostasAbertas: zod.number().optional(),
      emNegociacao: zod.number().optional(),
      leadsNovos24h: zod.number().optional(),
      leadsQuentes: zod.number().optional(),
      totalContatos: zod.number().optional(),
 ...
 */
export const GetCrmMeResponse = zod.object({
  success: zod.boolean(),
  user: zod.object({
    userId: zod.string(),
    ...
    roleLabels: zod.array(zod.string()).optional(),
  }),
});
 ...
 */
export const GetCrmDashboardParams = zod.object({
  persona: zod.enum(["executive", "coordenador", "operacional", "pos_venda"]),
});

export const GetCrmDashboardQueryParams = zod.object({
  period: zod.enum(["7d", "30d", "90d", "this_month", "all"]).optional(),
});
 ...
 */
export const GetCrmQueueParams = zod.object({
  type: zod.enum([
    "my_accounts",
    "my_deals",
    "team",
...
export const getCrmQueueQueryLimitMax = 200;

export const GetCrmQueueQueryParams = zod.object({
  limit: zod.coerce.number().max(getCrmQueueQueryLimitMax).optional(),
});

export const GetCrmQueueResponse = zod.object({
  success: zod.boolean(),
  type: zod.string(),
  contacts: zod.array(zod.object({}).passthrough()).optional(),
  deals: zod.array(zod.object({}).passthrough()).optional(),
  total: zod.number(),
});
 ...
 */
export const GetCrmQualityHealthResponse = zod.object({
  success: zod.boolean(),
  totalContacts: zod.number(),
  totalDeals: zod.number(),
  completenessPct: zod.number().optional(),
  withResponsiblePct: zod.number().optional(),
  withFollowupPct: zod.number().optional(),
  duplicates: zod.number().optional(),
  criticalIssues: zod.number().optional(),
  warningIssues: zod.number().optional(),
  infoIssues: zod.number().optional(),
  issues: zod.array(zod.object({}).passthrough()).optional(),
  topRules: zod
    .array(
      zod.object({
 ...
 */
export const GetCrmQualityIssuesResponse = zod.object({
  success: zod.boolean(),
  issues: zod.array(
    zod.object({
      rule: zod.string().optional(),
      severity: zod.enum(["info", "warning", "critical"]).optional(),
      entityType: zod.enum(["contact", "deal"]).optional(),
 ...
 */
export const GetCrmQualityDuplicatesResponse = zod.object({
  success: zod.boolean(),
  duplicates: zod.array(
    zod.object({
      field: zod.enum(["cnpj", "razao_social"]).optional(),
      value: zod.string().optional(),
 ...
 */
export const getCrmAuditLogQueryLimitMax = 500;

export const GetCrmAuditLogQueryParams = zod.object({
  entityType: zod.coerce.string().optional(),
  entityId: zod.coerce.number().optional(),
  action: zod.coerce.string().optional(),
  actorType: zod
    .enum(["user", "ia", "automation", "integration", "service"])
    .optional(),
  limit: zod.coerce.number().max(getCrmAuditLogQueryLimitMax).optional(),
});

export const GetCrmAuditLogResponse = zod.object({
  success: zod.boolean(),
 ...
 */
export const ListCrmUsersResponse = zod.object({
  success: zod.boolean(),
  users: zod.array(
    zod.object({
      userId: zod.string().optional(),
      roles: zod.array(zod.object({}).passthrough()).optional(),
    }),
  ),
  total: zod.number(),
});
 ...
 */
export const GrantCrmUserRoleParams = zod.object({
  userId: zod.coerce.string(),
});

export const GrantCrmUserRoleBody = zod.object({
  role: zod.enum(["admin", "coordenador", "comercial", "marketing", "leitura"]),
 ...
 */
export const RevokeCrmUserRoleParams = zod.object({
  userId: zod.coerce.string(),
  roleId: zod.coerce.number(),
});

export const RevokeCrmUserRoleResponse = zod.object({
  success: zod.boolean(),
});
 ...
 */
export const ListCrmRolesResponse = zod.object({
  success: zod.boolean(),
  roles: zod.array(zod.string()),
  labels: zod.object({}).passthrough(),
});

/**
 * @summary Get recent governance activity (audit + activities combined)
 */
export const getCrmGovernanceRecentQueryLimitMax = 200;

export const GetCrmGovernanceRecentQueryParams = zod.object({
  limit: zod.coerce
    .number()
    .max(getCrmGovernanceRecentQueryLimitMax)
    .optional(),
});

export const GetCrmGovernanceRecentResponse = zod.object({
  success: zod.boolean(),
  entries: zod.array(
    zod.object({
      source: zod.enum(["audit", "activity"]).optional(),
      id: zod.number().optional(),
      type: zod.string().optional(),
