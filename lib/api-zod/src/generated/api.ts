...
export const CreateConversationResponse = zod.void()
...
export const ExportConversationResponse = zod.unknown()
...
export const UploadKnowledgeDocumentResponse = zod.void()
...
export const CreateLlmConnectionResponse = zod.void()
...
export const DiscoverLlmModelsResponse = zod.record(zod.string(), zod.unknown())
...
export const CreateLlmProfileResponse = zod.void()
...
export const CreateCrmContactResponse = zod.void()
...
export const CreateCrmContactActivityResponse = zod.void()
...
export const CreateCrmContactAttachmentResponse = zod.void()
...
export const CreateCrmDealResponse = zod.void()
...
export const GetCrmPipelineResponse = zod.object({
  "success": zod.boolean(),
  "pipeline": zod.record(zod.string(), zod.array(zod.object({
  "id": zod.number(),
  "contactId": zod.number().nullish(),
  "pipelineId": zod.string(),
  "title": zod.string(),
...
export const CreateCrmTaskResponse = zod.void()
...
export const CreateCrmViewResponse = zod.void()
...
export const ListCrmPipelinesResponse = zod.object({
  "success": zod.boolean(),
  "pipelines": zod.array(zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "stages": zod.array(zod.string()),
  "isDefault": zod.boolean(),
...
export const CreateCrmPipelineResponse = zod.void()
...
export const CreateCrmAutomationResponse = zod.void()
...
export const GenerateDeliverableBody = zod.object({
  "contactId": zod.number().optional(),
  "dealId": zod.number().optional(),
  "type": zod.enum(['diagnostico', 'proposta', 'resumo_oportunidade', 'followup', 'roteiro_reuniao']),
  "product": zod.string().optional(),
  "title": zod.string().optional()
})

export const GenerateDeliverableResponse = zod.void()
...
export const ExportDeliverableResponse = zod.unknown()
...
export const GetAnalyticsDailyUsageResponse = zod.object({
  "usageByDay": zod.array(zod.object({
  "day": zod.string(),
  "tokens": zod.number(),
...
export const GetAnalyticsModelsResponse = zod.object({
  "modelStats": zod.array(zod.object({
  "model": zod.string(),
  "provider": zod.string(),
  "totalTokens": zod.number(),
  "calls": zod.number(),
...
export const GetAnalyticsCostTrendResponse = zod.object({
  "costByDay": zod.array(zod.object({
...
export const CreateAutomationSequenceResponse = zod.void()
...
export const EnrollInSequenceResponse = zod.void()
...
export const CreateAiTestCaseResponse = zod.void()
...
export const OrchestrateAgentsBody = zod.object({
  ...
  "agentId": zod.string(),
  "task": zod.string()
})).min(1).max(orchestrateAgentsBodyTasksMax),
