...
export type CrmSavedViewType = typeof CrmSavedViewType[keyof typeof CrmSavedViewType];
...
export type CreateCrmAutomationRequestActionPayload = { [key: string]: unknown };
...
export type UpdateCrmAutomationRequestActionPayload = { [key: string]: unknown };
...
export type CreateAutomationSequenceRequestStepsItem = { [key: string]: unknown };
...
export type UpdateAutomationSequenceRequestStepsItem = { [key: string]: unknown };
...
export type AiFeedbackRequestRating = typeof AiFeedbackRequestRating[keyof typeof AiFeedbackRequestRating];
...
export type ListCrmContactsSort = typeof ListCrmContactsSort[keyof typeof ListCrmContactsSort];
...
export type ListCrmContactsSortDir = typeof ListCrmContactsSortDir[keyof typeof ListCrmContactsSortDir];
...
export type BulkTagCrmContactsBodyAction = typeof BulkTagCrmContactsBodyAction[keyof typeof BulkTagCrmContactsBodyAction];
...
export type GetCrmAnalyticsOverview200ActivitiesByType = { [key: string]: unknown };
