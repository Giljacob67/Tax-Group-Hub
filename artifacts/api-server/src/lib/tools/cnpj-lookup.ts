...
export const cnpjLookupTool = tool({
  description:
    "Consulta dados e informações institucionais completos de uma empresa pelo CNPJ (via EmpresAqui). Retorna razão social, regime, telefone, endereço, porte e sócios. Use isso quando você receber o CNPJ de um lead.",
  inputSchema: z.object({
    cnpj: z
      .string()
      .describe("O CNPJ da empresa, apenas números ou formatado."),
  }),
