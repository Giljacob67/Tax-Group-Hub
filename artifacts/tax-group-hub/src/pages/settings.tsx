                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bg-background/50 rounded-lg p-3 border border-border/30">
                        ...
                        {integration.id === "openrouter" && integration.configured && (
                          <div className="mt-2 pt-2 border-t border-border/30">
                            <p className="text-[10px] uppercase tracking-wider text-muted-foreground mb-1">Modelo Ativo</p>
                            <code className="text-xs font-mono text-emerald-400">{data?.openrouterModel || "google/gemini-2.5-flash"}</code>
                          </div>
                        )}
                        {!integration.configured && (
        ...
        >
          ...
          <div className="pt-2 border-t border-border/30">
            <p className="text-xs text-muted-foreground">
              <strong>OpenRouter:</strong> Acesse <a href="https://openrouter.ai" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">openrouter.ai</a> para obter sua chave de API.
              O modelo padrao e o <code className="text-primary">Gemini 2.5 Flash</code>, mas voce pode trocar o modelo
              diretamente no chat usando o seletor de modelo no cabecalho.
            </p>
          </div>
        </motion.div>
      </div>
