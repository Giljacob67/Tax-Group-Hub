...
const STATUS_CONFIG: Record<string, { label: string; color: string }> = {
  nao_iniciado: {
    label: CONTACT_STATUS_LABELS.nao_iniciado,
    color: "bg-muted/40 text-muted-foreground border-border",
  },
  em_abordagem: {
    label: CONTACT_STATUS_LABELS.em_abordagem,
    color: "bg-blue-500/10 text-blue-500 border-blue-500/30",
  },
  respondeu: {
    label: CONTACT_STATUS_LABELS.respondeu,
    color: "bg-violet-500/10 text-violet-500 border-violet-500/30",
  },
  reuniao_agendada: {
    label: CONTACT_STATUS_LABELS.reuniao_agendada,
    color: "bg-purple-500/10 text-purple-500 border-purple-500/30",
  },
  qualificado: {
    label: CONTACT_STATUS_LABELS.qualificado,
    color: "bg-emerald-500/10 text-emerald-500 border-emerald-500/30",
  },
  enviado_matriz: {
    label: CONTACT_STATUS_LABELS.enviado_matriz,
    color: "bg-pink-500/10 text-pink-500 border-pink-500/30",
  },
  aguardando_matriz: {
    label: CONTACT_STATUS_LABELS.aguardando_matriz,
    color: "bg-orange-500/10 text-orange-500 border-orange-500/30",
  },
  proposta_enviada: {
    label: CONTACT_STATUS_LABELS.proposta_enviada,
    color: "bg-cyan-500/10 text-cyan-500 border-cyan-500/30",
  },
  em_negociacao: {
    label: CONTACT_STATUS_LABELS.em_negociacao,
    color: "bg-indigo-500/10 text-indigo-500 border-indigo-500/30",
  },
  cliente: {
    label: CONTACT_STATUS_LABELS.cliente,
    color: "bg-green-500/10 text-green-500 border-green-500/30",
  },
  sem_resposta: {
    label: CONTACT_STATUS_LABELS.sem_resposta,
    color: "bg-red-500/10 text-red-500 border-red-500/30",
  },
  reciclar_depois: {
    label: CONTACT_STATUS_LABELS.reciclar_depois,
    color: "bg-amber-500/10 text-amber-500 border-amber-500/30",
  },
  stand_by: {
    label: CONTACT_STATUS_LABELS.stand_by,
    color: "bg-gray-400/10 text-gray-400 border-gray-400/30",
  },
  perdido: {
    label: CONTACT_STATUS_LABELS.perdido,
    color: "bg-red-600/10 text-red-600 border-red-600/30",
  },
};

const STAGE_DICT: Record<
  string,
  { label: string; accent: string; header: string }
> = {
  // Pipeline stages (16 etapas Tax Group)
  lead_novo: {
    label: PIPELINE_STAGE_LABELS.lead_novo,
    accent: "border-t-slate-400",
    header: "text-slate-400",
  },
  qualificacao_comercial: {
    label: PIPELINE_STAGE_LABELS.qualificacao_comercial,
    accent: "border-t-blue-500",
    header: "text-blue-500",
  },
  reuniao_agendada: {
    label: PIPELINE_STAGE_LABELS.reuniao_agendada,
    accent: "border-t-violet-500",
    header: "text-violet-500",
  },
  diagnostico_comercial: {
    label: PIPELINE_STAGE_LABELS.diagnostico_comercial,
    accent: "border-t-amber-500",
    header: "text-amber-500",
  },
  enviado_para_matriz: {
    label: PIPELINE_STAGE_LABELS.enviado_para_matriz,
    accent: "border-t-pink-500",
    header: "text-pink-500",
  },
  aguardando_matriz: {
    label: PIPELINE_STAGE_LABELS.aguardando_matriz,
    accent: "border-t-orange-500",
    header: "text-orange-500",
  },
  proposta_pronta: {
    label: PIPELINE_STAGE_LABELS.proposta_pronta,
    accent: "border-t-emerald-500",
    header: "text-emerald-500",
  },
  apresentacao_ao_cliente: {
    label: PIPELINE_STAGE_LABELS.apresentacao_ao_cliente,
    accent: "border-t-cyan-500",
    header: "text-cyan-500",
  },
  negociacao: {
    label: PIPELINE_STAGE_LABELS.negociacao,
    accent: "border-t-indigo-500",
    header: "text-indigo-500",
  },
  fechado_ganho: {
    label: PIPELINE_STAGE_LABELS.fechado_ganho,
    accent: "border-t-green-500",
    header: "text-green-500",
  },
  perdido_standby: {
    label: PIPELINE_STAGE_LABELS.perdido_standby,
    accent: "border-t-red-500",
    header: "text-red-500",
  },
  onboarding_cliente: {
    label: PIPELINE_STAGE_LABELS.onboarding_cliente,
    accent: "border-t-teal-500",
    header: "text-teal-500",
  },
  execucao_pela_matriz: {
    label: PIPELINE_STAGE_LABELS.execucao_pela_matriz,
    accent: "border-t-purple-500",
    header: "text-purple-500",
  },
  acompanhamento_pendencias: {
    label: PIPELINE_STAGE_LABELS.acompanhamento_pendencias,
    accent: "border-t-amber-600",
    header: "text-amber-600",
  },
  pos_venda_expansao: {
    label: PIPELINE_STAGE_LABELS.pos_venda_expansao,
    accent: "border-t-blue-400",
    header: "text-blue-400",
  },
  encerrado: {
    label: PIPELINE_STAGE_LABELS.encerrado,
  ...
  proposta_em_preparacao: {
    label: DEAL_STAGE_LABELS.proposta_em_preparacao,
    accent: "border-t-violet-400",
    header: "text-violet-400",
  },
  proposta_enviada: {
    label: DEAL_STAGE_LABELS.proposta_enviada,
    accent: "border-t-cyan-400",
    header: "text-cyan-400",
  },
  proposta_apresentada: {
    label: DEAL_STAGE_LABELS.proposta_apresentada,
    accent: "border-t-indigo-400",
    header: "text-indigo-400",
  },
  em_negociacao: {
    label: DEAL_STAGE_LABELS.em_negociacao,
    accent: "border-t-purple-400",
    header: "text-purple-400",
  },
  perdido: {
    label: DEAL_STAGE_LABELS.perdido,
    accent: "border-t-red-400",
    header: "text-red-400",
  },
  stand_by: {
    label: DEAL_STAGE_LABELS.stand_by,
...
async function exportContactsToXlsx(contacts: Contact[]) {
  ...
  XLSX.writeFile(
    wb,
    `leads-tax-group-${new Date().toISOString().slice(0, 10)}.xlsx`,
  );
}
...
function SortIcon({
  ...
  if (!sort || sort.field !== field)
    return (
      <ChevronsUpDown className="w-3 h-3 ml-1 text-muted-foreground/40 inline" />
    );
  return sort.dir === "asc" ? (
...
export default function CRMPage() {
  ...
  const { data: pendingTasksData } = useListCrmTasks(
    { status: "pending" } as any,
    { query: { refetchInterval: 60_000 } } as any,
  );
  const pendingCount =
    pendingTasksData?.tasks?.filter(
      (t) =>
        t.dueDate &&
  ...
  return (
    <div className="flex h-full overflow-hidden bg-background" data-tour="crm">
      <Tabs
        ...
        onValueChange={(v) => {
          setActiveTab(v);
          if (v !== "contacts") setSelectedContact(null);
        }}
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 mb-5">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <TabsList className="bg-muted/50 border border-border/50 h-auto flex-wrap">
                <TabsTrigger
                  value="today"
                  className="text-xs data-[state=active]:bg-primary data-[state=active]:text-primary-foreground relative"
                >
                  Hoje
                  {pendingCount > 0 && (
...
function ContactsView({
  ...
  if (filters.loteProspeccao)
    contactsParams.loteProspeccao = filters.loteProspeccao;
  if (filters.produtoInteresse)
    contactsParams.produtoInteresse = filters.produtoInteresse;
  if (filters.responsavelUnidade)
    contactsParams.responsavelUnidade = filters.responsavelUnidade;
  ...
  if (filters.followupVencido)
    contactsParams.followupVencido = filters.followupVencido;
  if (filters.semAtividadeDias)
    contactsParams.semAtividadeDias = filters.semAtividadeDias;
  if (sort) {
    contactsParams.sort = sort.field;
    contactsParams.sortDir = sort.dir;
  }
  ...
  const bulkDeleteMutation = useBulkDeleteCrmContacts({
    mutation: {
      onSuccess: (_, variables) => {
        ...
        setSelectedIds(new Set());
        toast({
          title: `${variables.data.ids.length} contato(s) removido(s).`,
        });
      },
      onError: () =>
  ...
  const bulkStatusMutation = useBulkUpdateStatusCrmContacts({
    mutation: {
      onSuccess: (_, variables) => {
        ...
        toast({
          title: `${variables.data.ids.length} contato(s) atualizados.`,
        });
      },
      onError: () =>
  ...
  const bulkTagsMutation = useBulkTagCrmContacts({
    mutation: {
      onSuccess: (_, variables) => {
        ...
        setNewListName("");
        toast({
          title: `${variables.data.ids.length} contato(s) ${variables.data.action === "add" ? "adicionados à" : "removidos da"} lista "${variables.data.tag}".`,
        });
      },
      onError: () =>
  ...
  const bulkTempMutation = useBulkUpdateTemperatureCrmContacts({
    mutation: {
      ...
      onError: () =>
        toast({
          title: "Erro ao atualizar temperatura",
          variant: "destructive",
        }),
    },
  });
  ...
  const bulkAssignMutation = useBulkAssignCrmContacts({
    mutation: {
      onSuccess: (_, variables) => {
        ...
        setBulkAssignValue("");
        toast({
          title: `${variables.data.ids.length} contato(s) atribuído(s).`,
        });
      },
      onError: () =>
  ...
  const userViews = (savedViewsData?.views || []).filter(
    (v: any) => v.type !== "system",
  );
  const systemViews = (savedViewsData?.views || []).filter(
    (v: any) => v.type === "system",
  );
      ...
      <div className="flex-none px-6 pt-3 pb-2 border-b border-border/50 bg-card/50 space-y-3">
        ...
        <div className="flex gap-1.5 overflow-x-auto pb-1 scrollbar-none -mx-2 px-2 items-center">
          ...
          {SYSTEM_VIEW_CATEGORIES.map((cat) => {
            const catViews = systemViews.filter(
              (v: any) => v.category === cat.id,
            );
          ...
          <Dialog open={isSaveViewOpen} onOpenChange={setIsSaveViewOpen}>
            <DialogTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="rounded-full px-3 h-8 text-xs font-medium border-primary/30 text-primary hover:bg-primary/10 ml-1"
              >
            ...
            <DialogContent className="max-w-sm">
              <DialogHeader>
                ...
                <DialogDescription>
                  Salve os filtros atuais como uma lista. Ficará visível na
                  barra superior para acesso rápido.
                </DialogDescription>
              </DialogHeader>
              <div className="py-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="relative flex-1 min-w-[180px]">
            ...
            <Input
              ...
              className="pl-9"
              aria-label="Buscar contatos por razão social ou CNPJ"
            />
          </div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setFilters((f) => ({ ...f, regime: v === "_all" ? "" : v }))
                  }
                >
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFilters((f) => ({ ...f, cidade: e.target.value }))
                  }
                  className="h-8 text-xs"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  value={filters.setor}
                  onChange={(e) =>
                    setFilters((f) => ({ ...f, setor: e.target.value }))
                  }
                  className="h-8 text-xs"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  value={filters.loteProspeccao}
                  onChange={(e) =>
                    setFilters((f) => ({
                      ...f,
                      loteProspeccao: e.target.value,
                    }))
                  }
                  className="h-8 text-xs"
                />
              ...
              <div className="space-y-1">
                ...
                <Input
                  placeholder="Ex: João"
                  value={filters.responsavelUnidade}
                  onChange={(e) =>
                    setFilters((f) => ({
                      ...f,
                      responsavelUnidade: e.target.value,
                    }))
                  }
                  className="h-8 text-xs"
                />
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFilters((f) => ({ ...f, scoreMin: e.target.value }))
                  }
                  className="h-8 text-xs"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFilters((f) => ({ ...f, scoreMax: e.target.value }))
                  }
                  className="h-8 text-xs"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Select
                  value={filters.statusMatriz}
                  onValueChange={(v) =>
                    setFilters((f) => ({
                      ...f,
                      statusMatriz: v === "_all" ? "" : v,
                    }))
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
              ...
              <div className="space-y-1">
                ...
                <Select
                  value={filters.followupVencido}
                  onValueChange={(v) =>
                    setFilters((f) => ({
                      ...f,
                      followupVencido: v === "_all" ? "" : v,
                    }))
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
              ...
              <div className="space-y-1">
                ...
                <Select
                  value={filters.semAtividadeDias}
                  onValueChange={(v) =>
                    setFilters((f) => ({
                      ...f,
                      semAtividadeDias: v === "_all" ? "" : v,
                    }))
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
            ...
            <div className="flex items-center gap-1.5 ml-auto">
                    ...
                    <div className="space-y-2 py-3">
                      {Object.entries(STATUS_CONFIG).map(([k, v]) => (
                        <button
                          ...
                          onClick={() =>
                            bulkStatusMutation.mutate({
                              data: { ids: selectedArray, status: k },
                            })
                          }
                        ...
                        >
                          <Badge
                            variant="outline"
                            className={`text-xs border ${v.color}`}
                          >
                            {v.label}
                          </Badge>
                        </button>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            className="h-8 text-xs"
                            disabled={
                              !newListName.trim() || bulkTagsMutation.isPending
                            }
                            onClick={() =>
                              bulkTagsMutation.mutate({
                                data: {
                                  ids: selectedArray,
                                  tag: newListName.trim(),
                                  action: "add",
                                },
                              })
                            }
                      ...
                      <Button
                        ...
                        onClick={() =>
                          bulkAssignMutation.mutate({
                            data: {
                              ids: selectedArray,
                              responsavelUnidade: bulkAssignValue,
                            },
                          })
                        }
                      >
                    ...
                    <div className="space-y-3 py-3">
                      ...
                      <div className="flex gap-2">
                        <Button
                          className="flex-1"
                          disabled={
                            bulkFollowupMutation.isPending || !bulkFollowupDate
                          }
                          onClick={() =>
                            bulkFollowupMutation.mutate({
                              data: {
                                ids: selectedArray,
                                proximoFollowup: bulkFollowupDate,
                              },
                            })
                          }
                        >
              ...
              <Can permission="canEditAll">
                <Button
                  variant="outline"
                  size="sm"
                  className="text-xs h-7 gap-1 text-destructive hover:text-destructive border-destructive/30"
                  onClick={() => {
                    confirmDialogState[0](
                      {
                        title: "Excluir contatos?",
                        description: `Deletar ${selectedIds.size} contato(s)? Esta ação não pode ser desfeita.`,
                        variant: "destructive",
                        confirmLabel: "Excluir",
                      },
                      () =>
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="text-center py-14 border-t border-border/50">
            ...
            <h3 className="text-base font-medium">
              {activeFilterCount > 0
                ...
                : "Sua operação comercial ainda não tem empresas mapeadas"}
            </h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm" aria-label="Lista de contatos do CRM">
              <caption className="sr-only">Lista de contatos do CRM</caption>
              ...
              <tbody className="divide-y divide-border/30">
                {contacts.map((contact) => {
                  const s =
                    STATUS_CONFIG[contact.status] || STATUS_CONFIG.nao_iniciado;
                  ...
                  return (
                    ...
                    >
                            ...
                            {contact.tags && contact.tags.length > 0 && (
                              <div className="flex flex-wrap gap-1 mt-1">
                                {contact.tags.slice(0, 3).map((tag) => (
                                  <span
                                    key={tag}
                                    className="text-[10px] px-1.5 py-0.5 rounded bg-muted/50 text-muted-foreground border border-border/50"
                                  >
                                    {tag}
                                  </span>
                                ))}
                      ...
                      >
                        <span className="text-xs text-muted-foreground">
                          {contact.regimeTributario?.replace(/_/g, " ") || "—"}
                        </span>
                      </td>
                      <td
                        className="px-4 py-3 text-center"
                      ...
                      >
                        {contact.temperatura ? (
                          <span
                            ...
                            style={{
                              borderColor:
                                TEMPERATURA_OPTIONS.find(
                                  (t) => t.value === contact.temperatura,
                                )?.color || "#6B7280",
                              color:
                                TEMPERATURA_OPTIONS.find(
                                  (t) => t.value === contact.temperatura,
                      ...
                      >
                        ...
                        >
                          <SelectTrigger className="h-auto border-0 bg-transparent p-0 shadow-none ring-0 focus:ring-0">
                            <Badge
                              variant="outline"
                              className={`text-xs border ${s.color} cursor-pointer hover:opacity-80`}
                            >
                              {s.label}
                            </Badge>
                          </SelectTrigger>
...
function ContactDetailPanel({
  ...
  const enrichMutation = useEnrichCrmContact({
    mutation: {
      onSuccess: (data) => {
        ...
        queryClient.invalidateQueries({ queryKey: ["/api/crm/contacts"] });
        toast({
          title: `Dados enriquecidos! ${data.fieldsUpdated?.length || 0} campos atualizados.`,
        });
      },
      onError: (e: any) =>
        toast({
  ...
  const deleteMutation = useDeleteCrmContact({
    mutation: {
      ...
      onError: () =>
        toast({ title: "Erro ao deletar contato", variant: "destructive" }),
    },
  });
  ...
  const { data: attachmentsData, refetch: refetchAttachments } =
    useListCrmContactAttachments(contact.id);

  const { data: dealsData } = useListCrmDeals({ contactId: contact.id } as any);

  const { data: enrollmentsData } = useListSequenceEnrollments({
  ...
  if (activities.length > 0) {
    const daysSince = Math.floor(
      (Date.now() - new Date(activities[0].createdAt).getTime()) /
        (1000 * 60 * 60 * 24),
    );
    if (daysSince <= 3) {
              ...
              onClick={() => {
                ...
                logActivityMutation.mutate({
                  ...
                  data: {
                    ...
                    content: `Ligação para ${contact.telefone}`,
            ...
            <button
              onClick={() => {
                ...
                const text = encodeURIComponent(
                  `Olá, tudo bem? Meu nome é da Tax Group Hub e gostaria de conversar sobre oportunidades de otimização tributária para a ${name}.`,
                );
                window.open(
                  `https://wa.me/${fullPhone}?text=${text}`,
                  "_blank",
                );
                logActivityMutation.mutate({
                  id: contact.id,
      ...
      <div className="flex-none p-4 space-y-3 border-b border-border">
          ...
          <div className="flex-1 bg-background rounded-lg p-3 text-center border border-border">
            ...
            >
              <SelectTrigger className="h-auto border-0 bg-transparent p-0 text-center focus:ring-0 shadow-none">
                <Badge
                  variant="outline"
                  className={`text-xs border ${status.color} cursor-pointer`}
                >
                  {status.label}
                </Badge>
              </SelectTrigger>
        ...
        {(enrollmentsData?.enrollments?.length ?? 0) > 0 && (
          <div className="space-y-1">
            {(enrollmentsData as any)?.enrollments?.map((en: any) => {
              ...
              const pct =
                total > 0 ? Math.round((en.currentStep / total) * 100) : 0;
              return (
                <div
                  key={en.id}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xs font-medium text-primary truncate">
                      {en.sequenceName ?? "Sequência"}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      Etapa {en.currentStep + 1}/{total} · {pct}% concluído
                    </div>
                  </div>
        ...
        <div className="flex gap-2">
          <Button
            ...
            onClick={() => enrichMutation.mutate({ id: contact.id })}
          >
          ...
          <Button
            ...
            onClick={() => qualifyMutation.mutate({ id: contact.id })}
          >
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                {[
                  {
                    label: "Regime",
                    value: contact.regimeTributario?.replace(/_/g, " "),
                  },
                  ...
                  { label: "Faturamento", value: contact.faturamentoEstimado },
                  {
                    ...
                    value: contact.valorPotencial
                      ? `R$ ${Number(contact.valorPotencial).toLocaleString("pt-BR")}`
                      : undefined,
                  },
                  { label: "Responsável", value: contact.responsavelUnidade },
                  {
                    label: "Próx. Follow-up",
                    value: contact.proximoFollowup
                      ? new Date(contact.proximoFollowup).toLocaleDateString(
                          "pt-BR",
                        )
                      : undefined,
                  },
                  ...
                  {
                    label: "Sócios",
                    value: Array.isArray(contact.socios)
                      ? contact.socios.map((s: any) => s.nome).join(", ")
                      : undefined,
                  },
                  ...
                  .map((f) => (
                    <div key={f.label} className="flex gap-2 text-xs">
                      <span className="text-muted-foreground w-24 flex-shrink-0 pt-0.5">
                        {f.label}
                      </span>
                      <span className="text-foreground flex-1 break-words leading-relaxed">
                        {f.value}
                      </span>
                    </div>
                  ))}
                ...
                {(contact.pendenciasCliente ||
                  contact.pendenciasUnidade ||
                  contact.pendenciasMatriz) && (
                  <>
                    ...
                    {[
                      ...
                      .map((f) => (
                        <div key={f.label} className="flex gap-2 text-xs">
                          ...
                          <span className="text-foreground flex-1 break-words leading-relaxed whitespace-pre-wrap">
                            {f.value}
                          </span>
                        </div>
                      ))}
            ...
            <div className="p-4 space-y-3">
              {!showNewDealForm ? (
                ...
                <div className="space-y-2 p-3 border border-border/50 rounded-xl bg-background/50">
                  ...
                  <Select
                    value={newDealOrigem}
                    onValueChange={setNewDealOrigem}
                  >
                  ...
                  <Select
                    value={newDealStatusMatriz}
                    onValueChange={setNewDealStatusMatriz}
                  >
                    <SelectTrigger className="text-xs h-8">
                      <SelectValue placeholder="Status Matriz" />
                    </SelectTrigger>
                    <SelectContent>
                      {MATRIX_STATUSES.map((s) => (
                        <SelectItem key={s} value={s}>
                  ...
                  <Textarea
                    placeholder="Resumo do diagnóstico comercial"
                    value={newDealResumoDiag}
                    onChange={(e) => setNewDealResumoDiag(e.target.value)}
                    className="text-xs min-h-[48px] resize-none"
                  />
                  <Textarea
                    placeholder="Briefing para a matriz"
                    value={newDealBriefing}
                    onChange={(e) => setNewDealBriefing(e.target.value)}
                    className="text-xs min-h-[48px] resize-none"
                  />
                  <Textarea
                    placeholder="Observações de negociação"
                    value={newDealObsNegociacao}
                    onChange={(e) => setNewDealObsNegociacao(e.target.value)}
                    className="text-xs min-h-[48px] resize-none"
                  />
                  <div className="flex gap-2">
                    <Button
              ...
              {deals.length === 0 ? (
                ...
                <div className="space-y-2">
                  {(deals as any[]).map((d) => (
                    <div
                      key={d.id}
                      className="p-3 rounded-lg border border-border/50 bg-card hover:border-primary/30 transition-colors"
                    >
                      <div className="flex justify-between items-start gap-2">
                        <p className="text-xs font-semibold">{d.title}</p>
                        <Badge
                          variant="outline"
                          className="text-[11px] whitespace-nowrap bg-muted/50"
                        >
                          {STAGE_DICT[d.stage]?.label || d.stage}
                        </Badge>
                      </div>
                        ...
                        <div className="mt-2">
                          <span
                            ...
                            style={{
                              borderColor:
                                MATRIX_STATUS_COLORS[
                                  d.statusMatriz as keyof typeof MATRIX_STATUS_COLORS
                                ] || "#6B7280",
                              color:
                                MATRIX_STATUS_COLORS[
                                  d.statusMatriz as keyof typeof MATRIX_STATUS_COLORS
                          ...
                          >
                            Matriz:{" "}
                            {MATRIX_STATUS_LABELS[
                              d.statusMatriz as keyof typeof MATRIX_STATUS_LABELS
                            ] || d.statusMatriz}
                          </span>
                        </div>
                      )}
            ...
            <div className="p-4 space-y-3">
                ...
                <div className="border border-border/60 rounded-lg p-3 space-y-2.5 bg-muted/20">
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      (!activitySubject && !activityContent)
                    }
                  >
                    {logActivityMutation.isPending ? (
                      <Loader2 className="w-3 h-3 animate-spin mr-1.5" />
              ...
              {!activitiesData ? (
                ...
                <div className="space-y-3">
                  {((activitiesData as any)?.activities || []).map(
                    (a: Activity) => {
...
function DealEditModal({
  ...
  const [motivoPerda, setMotivoPerda] = useState(
    (deal as any).motivoPerda || "",
  );
  const [statusProposta, setStatusProposta] = useState(
    (deal as any).statusProposta || "",
  );
  const [dataEnvioMatriz, setDataEnvioMatriz] = useState(
    (deal as any).dataEnvioMatriz
      ? new Date((deal as any).dataEnvioMatriz).toISOString().slice(0, 10)
      : "",
  );
  const [prazoRetornoMatriz, setPrazoRetornoMatriz] = useState(
    (deal as any).prazoRetornoMatriz
      ? new Date((deal as any).prazoRetornoMatriz).toISOString().slice(0, 10)
      : "",
  );
  const [dataRetornoMatriz, setDataRetornoMatriz] = useState(
    (deal as any).dataRetornoMatriz
      ? new Date((deal as any).dataRetornoMatriz).toISOString().slice(0, 10)
      : "",
  );
  const [retornoMatriz, setRetornoMatriz] = useState(
    (deal as any).retornoMatriz || "",
  );
  const [documentosEnviados, setDocumentosEnviados] = useState(
    ((deal as any).documentosEnviados || []).join(", "),
  );
  const [responsavelEnvioMatriz, setResponsavelEnvioMatriz] = useState(
    (deal as any).responsavelEnvioMatriz || "",
  );
  const [pendenciasMatriz, setPendenciasMatriz] = useState(
    (deal as any).pendenciasMatriz || "",
  );
  const [showDeleteConfirm, setShowDeleteConfirm] = useState(false);
      ...
      <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Select value={stage} onValueChange={setStage}>
              ...
              <SelectContent>
                {DEAL_STAGES.map((s) => (
                  <SelectItem key={s} value={s}>
                    <span className={STAGE_DICT[s]?.header || ""}>
                      {DEAL_STAGE_LABELS[s]}
                    </span>
                  </SelectItem>
                ))}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => setStatusProposta(v === "_none" ? "" : v)}
              >
                <SelectTrigger className="text-sm h-9">
                  <SelectValue placeholder="Selecionar..." />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => setResponsavelEnvioMatriz(e.target.value)}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => setDataEnvioMatriz(e.target.value)}
                  className="text-sm h-9"
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => setPrazoRetornoMatriz(e.target.value)}
                  className="text-sm h-9"
                />
              </div>
            </div>
          ...
          {[
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => setDocumentosEnviados(e.target.value)}
            ...
            <>
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => setDataRetornoMatriz(e.target.value)}
                  className="text-sm h-9"
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Textarea
                  value={retornoMatriz}
                  onChange={(e) => setRetornoMatriz(e.target.value)}
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            onChange={(e) => setResumoDiagnosticoComercial(e.target.value)}
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            onChange={(e) => setBriefingMatriz(e.target.value)}
            placeholder="Briefing para a matriz..."
            className="text-sm min-h-[60px] resize-none"
          />
        </div>
...
function PipelineKanbanView({
  ...
  const savedGoal =
    typeof window !== "undefined"
      ? Number(localStorage.getItem(MONTHLY_GOAL_KEY) || 50000)
      : 50000;
  const [monthlyGoal, setMonthlyGoal] = useState(savedGoal);
  const [editingGoal, setEditingGoal] = useState(false);
  const [goalInput, setGoalInput] = useState(String(savedGoal));

  const pipelineQueryParam =
    activePipelineId === "default" ? "" : `?pipelineId=${activePipelineId}`;

  const { data, isLoading } = useGetCrmPipeline({
    pipelineId: activePipelineId === "default" ? undefined : activePipelineId,
  } as any);
  ...
  const moveDealMutation = useUpdateCrmDeal({
    mutation: {
      onSuccess: (_, variables) => {
        ...
        toast({
          title: `Negócio movido para ${STAGE_DICT[variables.data.stage!]?.label || variables.data.stage}`,
        });
      },
      onError: () => {
        queryClient.invalidateQueries({
  ...
  function handleDrop(e: React.DragEvent, targetStage: string) {
    ...
    if (draggedDealId && targetStage !== draggedFromStage) {
      queryClient.setQueryData<any>(["/api/crm/deals/pipeline"], (old: any) => {
        ...
        newPipeline[draggedFromStage!] = (
          newPipeline[draggedFromStage!] || []
        ).filter((d: Deal) => d.id !== draggedDealId);
  ...
  if (isDemo && stages.length === 0 && Object.keys(pipeline).length === 0) {
    ...
    for (const s of stages) {
      demoPipeline[s] = DEMO_DEALS.filter(
        (d) => d.stage === s,
      ) as unknown as Deal[];
    }
  ...
  const pipelinePct = Math.min(
    100,
    Math.round(((wonValue + weightedValue) / monthlyGoal) * 100),
  );
    ...
    <div className="h-full flex flex-col gap-3 p-6">
      ...
      <div className="bg-card/50 border border-border/40 rounded-xl p-3 flex-none">
                ...
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      ...
                      if (v > 0) {
                        setMonthlyGoal(v);
                        localStorage.setItem(MONTHLY_GOAL_KEY, String(v));
                      }
        ...
        <div className="flex items-center justify-between mt-1.5">
          ...
          <span
            className={`text-xs font-bold ${progressPct >= 100 ? "text-emerald-400" : progressPct >= 70 ? "text-amber-400" : "text-muted-foreground"}`}
          >
            {progressPct}% da meta
          </span>
        </div>
        ...
        {[
          {
            ...
            value: formatCurrencyShort(totalActiveValue),
            icon: BarChart3,
            color: "text-primary",
          },
          {
            label: "Valor Ponderado",
            value: formatCurrencyShort(weightedValue),
            icon: Target,
          ...
          <div
            key={stat.label}
            className="bg-card/50 border border-border/40 rounded-xl p-3 flex items-center gap-3"
          >
      ...
      {allDeals.length === 0 && (
        <div className="text-center py-10 text-sm text-muted-foreground border border-dashed border-border/40 rounded-xl bg-card/30">
          ...
          <p className="text-xs mt-1 max-w-md mx-auto">
            Sua operação comercial ainda não tem negócios em andamento.
            Qualifique um lead no CRM ou crie uma oportunidade manualmente.
          </p>
        </div>
      )}
      ...
      <div className="flex-1 overflow-x-auto overflow-y-hidden">
        ...
        >
          {kanbanPhases.map((phase) => {
            ...
            const isDropTarget =
              dragOverStage === stageId && draggedFromStage !== stageId;
              ...
              >
                ...
                <div className="p-3 border-b border-border/50 flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <button
                      onClick={() =>
                        setAddingInStage(isAdding ? null : stageId)
                      }
                ...
                >
                  {deals.length === 0 && !isAdding ? (
                    <div
                      className={`h-16 flex items-center justify-center border border-dashed rounded-lg transition-colors ${
                        isDropTarget
    ...
    >
      <div className="p-3 space-y-2">
        ...
        <div className="flex items-center justify-between gap-2">
          {deal.produto && (
            <Badge variant="secondary" className="text-[11px] py-0 px-1.5 h-4">
              {deal.produto}
            </Badge>
          )}
          {deal.value && (
        ...
        {deal.statusMatriz && deal.statusMatriz !== "nao_enviado" && (
          <span
            ...
            style={{
              borderColor:
                MATRIX_STATUS_COLORS[
                  deal.statusMatriz as keyof typeof MATRIX_STATUS_COLORS
                ] || "#6B7280",
              color:
                MATRIX_STATUS_COLORS[
                  deal.statusMatriz as keyof typeof MATRIX_STATUS_COLORS
          ...
          >
            Matriz:{" "}
            {MATRIX_STATUS_LABELS[
              deal.statusMatriz as keyof typeof MATRIX_STATUS_LABELS
            ] || deal.statusMatriz}
          </span>
        )}
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <span
            className={`text-[11px] px-1.5 py-0.5 rounded-full border font-medium ml-auto ${urgencyColor}`}
          >
