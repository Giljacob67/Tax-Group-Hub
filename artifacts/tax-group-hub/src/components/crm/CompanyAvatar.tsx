export function CompanyAvatar({ name, size = "md", className }: { name: string | null; size?: "sm" | "md" | "lg"; className?: string }) {
  ...
  const colors = [
    "from-green-700 to-green-500",   "from-teal-700 to-teal-500",
    "from-slate-600 to-slate-400",   "from-stone-600 to-stone-400",
    "from-green-800 to-green-600",   "from-cyan-800 to-cyan-600",
  ];
